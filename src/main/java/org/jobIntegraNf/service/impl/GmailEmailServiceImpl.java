...
public class GmailEmailServiceImpl implements EmailService {
    ...
    private Session createSession() {
        ...
        props.put("mail.smtp.host", EmailUtils.SMTP_HOST);
        props.put("mail.smtp.port", EmailUtils.SMTP_PORT);
        ...
        Session s = Session.getInstance(props, new Authenticator() {
            ...
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication(EmailUtils.SMTP_USERNAME, EmailUtils.SMTP_PASSWORD);
            }
        });
    ...
    public boolean sendEmail(EmailMessage message) throws EmailException {
        try {
            ...
            mime.setFrom(new InternetAddress(EmailUtils.SMTP_USERNAME));
            InternetAddress[] toAddresses = InternetAddress.parse(EmailUtils.DESTINATARIO);
            ...
            throw new EmailException("Erro ao enviar e-mail para " + EmailUtils.DESTINATARIO);
        }
        return true;
    }
}
